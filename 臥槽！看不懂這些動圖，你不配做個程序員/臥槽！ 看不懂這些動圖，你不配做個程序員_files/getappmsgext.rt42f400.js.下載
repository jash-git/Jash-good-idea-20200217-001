...
"use strict";
var n=e("biz_wap/jsapi/core.js"),i=e("biz_common/dom/event.js"),o=e("biz_wap/utils/mmversion.js"),t=e("appmsg/pay_report_utils.js"),a=function(e){
var n=arguments.length<=1||void 0===arguments[1]?document:arguments[1];
return n.querySelector(e);
},r=document.documentElement&&document.documentElement.clientWidth||window.innerWidth;
try{
var s=a("#img-content").getBoundingClientRect();
s.width&&(r=s.width);
}catch(d){
console.error(d);
}
var p=32,c=8,w={
dom:{
payFee:[a("#js_pay_panel .js_pay_fee"),a("#js_pay_panel_bottom .js_pay_fee")],
wrap:a("#js_pay_wall_wrap"),
payNum:a("#js_pay_num"),
wall:a("#js_pay_wall")
},
perLine:null,
...
for(var i=3*w.perLine,o="",t=0,a=n.pay_head_imgs.length;a>t&&(o+='<img src="'+n.pay_head_imgs[t]+'">',
!(t>=i-1));t++);
e.wall.innerHTML=o;
},m=function(){
i.tap(w.dom.payNum,function(){
u("/mp/paysub?action=evaluate_show_page&__biz="+window.biz+"&mid="+window.mid+"&idx="+window.idx+"&sn="+window.sn+"&link="+encodeURIComponent(window.msg_link)+"&from_scene="+window.source+"&from_subscene="+window.subscene+"&is_fans="+window.isFans);
});
},l=function(e){
...
}(),o.isIOS&&e.fee&&(window.IAPProductInfo?("CNY"!==window.IAPProductInfo.currencyCode&&t.report110809(40),
t.reportOverseaPay(window.IAPProductInfo.currencyCode,100*window.IAPProductInfo.price.toFixed(2),1,window.IAPProductInfo.invokeTime,window.IAPProductInfo.countryCode,0,window.IAPProductInfo.err_msg)):window.oriProductFee=Math.floor(e.fee/100)),
e.pay_cnt){
if(e.is_paid){
...
if(null===w.perLine){
var e=p+c;
w.perLine=Math.floor(.8*r/e),w.dom.wall.parentNode.style.width=w.perLine*e-c+"px";
}
return w.perLine;
};
return{
